...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="card">
      ...
      <div class="card-body">
        <form role="form" method="POST" action="{{URL::to('/')}}/home/book/create/store" enctype="multipart/form-data" class="bookform" id="signup" >
          {{ csrf_field() }}
          <div class="modal-body" >
            <div class="row">
              ...
              <div class="form-group col-sm-12">
                ...
                <small class="text-danger mr-4">*required</small>
                <select name="publisher_id" id="publisher_id" class="form-control js-single">
              ...
              <div class="form-group col-sm-12">
                ...
                <small class="text-danger mr-4">*required</small>
                <select name="bookrack_id" id="bookrack_id" class="form-control js-single">
...
$(document).ready(function(){
 ...
 $.ajax({
  ...
  success:function(result)
  {
   ...
   {
    $('#error_bookcode').html('<label class="text-danger">This Bookcode is already taken</label>');
